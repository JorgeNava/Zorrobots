 ...
 */
@Autonomous(name="Red_Back_40")
public class Red_Back_40 extends LinearOpMode {
    //WHEELS
    ...
    public void HitJewel(double posD,double posU) {
        RightJServo.setPosition(posD);
        sleep(3000);
        CheckJewelColor();
        sleep(2000);
        if (JewelColor == "red") {
            Right_motors.setPower(-.3);
            sleep(1000);
            Stop();
            RightJServo.setPosition(posU);
            sleep(1000);
            Reverse(.4);
            sleep(1500);
            stop();
